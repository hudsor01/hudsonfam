# v3.5 — CI/CD Hardening — Requirements (archived)

_Archived 2026-04-25 at milestone close. Snapshot of `.planning/REQUIREMENTS.md` at the close-out commit. Original file removed via `git rm` immediately after this snapshot._
