...
- [ ] **Phase 23: Owner-Triggered Workflows (Pattern Setter)** — EXECUTING (3/8 plans; 23-01 + 23-04 + 23-02 landed). "Research this company" manual trigger, regenerate cover letter, HMAC-SHA256 + X-Idempotency-Key + sentinel-error scrubbing pattern established and retrofit to existing fireWebhook
