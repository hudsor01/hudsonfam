export function Hero() {
  return (
    <section className="text-center py-16 sm:py-20 px-5 motion-safe:animate-fade-in-up">
      ...
      <h1 className="text-4xl sm:text-5xl font-serif text-foreground font-normal mb-3">
        The Hudson Family
      </h1>
      <p className="text-muted-foreground italic text-base sm:text-lg max-w-xl mx-auto">
