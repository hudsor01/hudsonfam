      ...
      data: [
        {
          ...
          albumId: album.id,
          originalPath: "/photos/originals/moving-truck.jpg",
          thumbnailPath: "/api/images/placeholder/1",
          width: 1600,
          height: 1200,
        ...
        },
        {
          ...
          albumId: album.id,
          originalPath: "/photos/originals/dallas-sunset.jpg",
          thumbnailPath: "/api/images/placeholder/2",
          width: 1600,
          height: 900,
        ...
        },
        {
          ...
          albumId: album.id,
          originalPath: "/photos/originals/white-rock-lake.jpg",
          thumbnailPath: "/api/images/placeholder/3",
          width: 1200,
          height: 1600,
        ...
        },
        {
          ...
          albumId: album.id,
          originalPath: "/photos/originals/kitchen.jpg",
          thumbnailPath: "/api/images/placeholder/4",
          width: 1600,
          height: 1200,
        ...
        },
        {
          ...
          albumId: album.id,
          originalPath: "/photos/originals/bishop-arts-coffee.jpg",
          thumbnailPath: "/api/images/placeholder/5",
          width: 1200,
          height: 1200,
        ...
        },
        {
          ...
          albumId: album.id,
          originalPath: "/photos/originals/homelab-setup.jpg",
          thumbnailPath: "/api/images/placeholder/6",
          width: 1600,
          height: 1200,
